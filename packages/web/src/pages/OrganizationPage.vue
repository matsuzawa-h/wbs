...
.search { padding: 0.35rem 0.5rem; border: 1px solid #d1d5db; border-radius: 4px; font: inherit; width: 260px; }
...
.org-table { width: 100%; border-collapse: collapse; background: #fff; border: 1px solid #e5e7eb; border-radius: 6px; overflow: hidden; font-size: 0.88rem; }
.org-table th, .org-table td { padding: 0.45rem 0.6rem; text-align: left; border-bottom: 1px solid #f1f5f9; }
.org-table th { background: #f8fafc; font-weight: 600; color: #475569; }
.org-table tr.inactive td { color: #94a3b8; background: #f9fafb; }
.col-code { width: 100px; font-family: 'Menlo', 'Consolas', monospace; font-size: 0.83rem; }
.col-name { font-weight: 600; }
.col-parent { color: #475569; }
